...
function deal_with_y_type(req,res){
	...
	get_smys(req,function(err,datas){
		...
		if(nl.more){
			ret.more=util.format('/frame/monthsmy/history/list?pa_id=%s',person.id);
		}
		res.send(ret);
	})
...
function deal_with_g_type(req,res){
	get_plans(req,function(err,datas){
		...
		if(nl.more){
			ret.more=util.format('/frame/monthplan/history/list?pa_id=%s',person.id);
		}
		res.send(ret);
	})
}
...
function get_smys(req,callback){
	var person=req.pa.person;
	step(
		function(){
...
function get_plans(req,callback){
	var person=req.pa.person;
	step(
		function(){
